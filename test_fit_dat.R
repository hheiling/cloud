# Experiment with fit_dat in more time-saving manner (vs updating package for every fix)

# With adaptive random walk
fit_dat_test = function(dat,  lambda0 = 0, lambda1 = 0, conv = 0.001, nMC = 1000, 
         family = "binomial", trace = 0, penalty = "grMCP",
         alpha = 1, nMC_max = 5000, t = 10,
         returnMC = T, ufull = NULL, coeffull = NULL, gibbs = T, maxitEM = 100, 
         ufullinit = NULL, 
         MwG_sampler = c("random_walk","independence"),
