...
# Part 2 of sim_table2_Pajor.R file - runs the sd_option = 2.0 option
# Test to see if foreach function works
...
row_labels = c(rep(str_c("sd_", sd_options), times = s_l))
rownames(output) = row_labels

save(output, file = "sim_table2_Pajor_output2.RData")
